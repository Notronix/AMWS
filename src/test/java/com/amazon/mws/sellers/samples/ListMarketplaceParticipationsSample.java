...
/** Sample call for ListMarketplaceParticipations. */
public class ListMarketplaceParticipationsSample {
     ...
     * @return The response.
     */
    public static ListMarketplaceParticipationsResponse invokeListMarketplaceParticipations(
            MarketplaceWebServiceSellers service,
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        ListMarketplaceParticipationsSample.invokeListMarketplaceParticipations(client, request);
