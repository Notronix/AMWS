...
/**
 * Sample call for GetSubscription.
 */
public class GetSubscriptionSample
{
    private static GetSubscriptionResponse invokeGetSubscription(MWSSubscriptionsService service, GetSubscriptionInput request)
    {
        try
        {
            // Call the service.
            GetSubscriptionResponse response = service.getSubscription(request);
    ...
    public static void main(String[] args)
    {
        ...
        // Make the call.
        GetSubscriptionSample.invokeGetSubscription(MWSSubscriptionsServiceSampleConfig.getClient(), request);
    }
}
