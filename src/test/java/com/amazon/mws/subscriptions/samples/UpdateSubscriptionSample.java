...
/** Sample call for UpdateSubscription. */
public class UpdateSubscriptionSample {
     ...
     * @return The response.
     */
    public static UpdateSubscriptionResponse invokeUpdateSubscription(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        UpdateSubscriptionSample.invokeUpdateSubscription(client, request);
