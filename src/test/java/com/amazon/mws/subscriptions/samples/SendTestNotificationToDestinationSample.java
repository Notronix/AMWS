...
/** Sample call for SendTestNotificationToDestination. */
public class SendTestNotificationToDestinationSample {
     ...
     * @return The response.
     */
    public static SendTestNotificationToDestinationResponse invokeSendTestNotificationToDestination(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        SendTestNotificationToDestinationSample.invokeSendTestNotificationToDestination(client, request);
