...
/** Sample call for DeregisterDestination. */
public class DeregisterDestinationSample {
     ...
     * @return The response.
     */
    public static DeregisterDestinationResponse invokeDeregisterDestination(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        DeregisterDestinationSample.invokeDeregisterDestination(client, request);
