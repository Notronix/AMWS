...
/** Sample call for ListSubscriptions. */
public class ListSubscriptionsSample {
     ...
     * @return The response.
     */
    public static ListSubscriptionsResponse invokeListSubscriptions(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        ListSubscriptionsSample.invokeListSubscriptions(client, request);
