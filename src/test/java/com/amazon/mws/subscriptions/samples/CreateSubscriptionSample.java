...
/** Sample call for CreateSubscription. */
public class CreateSubscriptionSample {
     ...
     * @return The response.
     */
    public static CreateSubscriptionResponse invokeCreateSubscription(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        CreateSubscriptionSample.invokeCreateSubscription(client, request);
