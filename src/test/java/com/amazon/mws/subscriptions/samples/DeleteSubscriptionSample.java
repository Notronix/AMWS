...
/** Sample call for DeleteSubscription. */
public class DeleteSubscriptionSample {
     ...
     * @return The response.
     */
    public static DeleteSubscriptionResponse invokeDeleteSubscription(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        DeleteSubscriptionSample.invokeDeleteSubscription(client, request);
