...
/** Sample call for RegisterDestination. */
public class RegisterDestinationSample {
     ...
     * @return The response.
     */
    public static RegisterDestinationResponse invokeRegisterDestination(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        RegisterDestinationSample.invokeRegisterDestination(client, request);
