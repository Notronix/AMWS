...
/** Sample call for UpdateInboundShipment. */
public class UpdateInboundShipmentSample {
     ...
     * @return The response.
     */
    public static UpdateInboundShipmentResponse invokeUpdateInboundShipment(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        UpdateInboundShipmentSample.invokeUpdateInboundShipment(client, request);
