...
/** Sample call for GetPackageLabels. */
public class GetPackageLabelsSample {
     ...
     * @return The response.
     */
    public static GetPackageLabelsResponse invokeGetPackageLabels(
            FBAInboundServiceMWS client, 
            GetPackageLabelsRequest request) {
        try {
            // Call the service.
            GetPackageLabelsResponse response = client.getPackageLabels(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        GetPackageLabelsSample.invokeGetPackageLabels(client, request);
