...
/** Sample call for GetPreorderInfo. */
public class GetPreorderInfoSample {
     ...
     * @return The response.
     */
    public static GetPreorderInfoResponse invokeGetPreorderInfo(FBAInboundServiceMWS client, GetPreorderInfoRequest request) {
        try {
            // Call the service.
            GetPreorderInfoResponse response = client.getPreorderInfo(request);
    ...
    public static void main(String[] args) {
        ...
        FBAInboundServiceMWS service = FBAInboundServiceMWSSampleConfig.getClient();
        ...
        // Make the call.
        GetPreorderInfoSample.invokeGetPreorderInfo(service, request);
