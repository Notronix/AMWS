...
/** Sample async call for ListInboundShipmentItems. */
public class ListInboundShipmentItemsAsyncSample {
     ...
     * @return The response.
     */
    public static List<Object> invokeListInboundShipmentItems(
            FBAInboundServiceMWSAsync client, 
            List<ListInboundShipmentItemsRequest> requestList) {
        // Call the service async.
        List<Future<ListInboundShipmentItemsResponse>> futureList = 
            new ArrayList<Future<ListInboundShipmentItemsResponse>>();
        for (ListInboundShipmentItemsRequest request : requestList) {
            Future<ListInboundShipmentItemsResponse> future = 
                client.listInboundShipmentItemsAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<ListInboundShipmentItemsResponse> future : futureList) {
            Object xresponse;
            try {
    ...
    public static void main(String[] args) {
        ...
        List<ListInboundShipmentItemsRequest> requestList = new ArrayList<ListInboundShipmentItemsRequest>();
        ...
        // Make the calls.
        ListInboundShipmentItemsAsyncSample.invokeListInboundShipmentItems(client, requestList);
