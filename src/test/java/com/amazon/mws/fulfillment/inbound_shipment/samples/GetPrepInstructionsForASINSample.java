...
/** Sample call for GetPrepInstructionsForASIN. */
public class GetPrepInstructionsForASINSample {
     ...
     * @return The response.
     */
    public static GetPrepInstructionsForASINResponse invokeGetPrepInstructionsForASIN(
            FBAInboundServiceMWS client, 
            GetPrepInstructionsForASINRequest request) {
        try {
            // Call the service.
            GetPrepInstructionsForASINResponse response = client.getPrepInstructionsForASIN(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        GetPrepInstructionsForASINSample.invokeGetPrepInstructionsForASIN(client, request);
