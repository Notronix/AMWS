...
/** Sample call for VoidTransportRequest. */
public class VoidTransportRequestSample {
     ...
     * @return The response.
     */
    public static VoidTransportRequestResponse invokeVoidTransportRequest(
            FBAInboundServiceMWS client, 
            VoidTransportInputRequest request) {
        try {
            // Call the service.
            VoidTransportRequestResponse response = client.voidTransportRequest(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        VoidTransportRequestSample.invokeVoidTransportRequest(client, request);
