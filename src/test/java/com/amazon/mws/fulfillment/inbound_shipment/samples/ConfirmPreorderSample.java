...
/** Sample call for ConfirmPreorder. */
public class ConfirmPreorderSample {
     ...
     * @return The response.
     */
    public static ConfirmPreorderResponse invokeConfirmPreorder(
            FBAInboundServiceMWS client, 
            ConfirmPreorderRequest request) {
        try {
            // Call the service.
            ConfirmPreorderResponse response = client.confirmPreorder(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        ConfirmPreorderSample.invokeConfirmPreorder(client, request);
