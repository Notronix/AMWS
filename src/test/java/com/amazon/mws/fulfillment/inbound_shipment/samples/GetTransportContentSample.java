...
/** Sample call for GetTransportContent. */
public class GetTransportContentSample {
     ...
     * @return The response.
     */
    public static GetTransportContentResponse invokeGetTransportContent(
            FBAInboundServiceMWS client, 
            GetTransportContentRequest request) {
        try {
            // Call the service.
            GetTransportContentResponse response = client.getTransportContent(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        GetTransportContentSample.invokeGetTransportContent(client, request);
