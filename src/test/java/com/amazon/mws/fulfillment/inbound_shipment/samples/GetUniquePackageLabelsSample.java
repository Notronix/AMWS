...
/** Sample call for GetUniquePackageLabels. */
public class GetUniquePackageLabelsSample {
     ...
     * @return The response.
     */
    public static GetUniquePackageLabelsResponse invokeGetUniquePackageLabels(
            FBAInboundServiceMWS client, 
            GetUniquePackageLabelsRequest request) {
        try {
            // Call the service.
            GetUniquePackageLabelsResponse response = client.getUniquePackageLabels(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        GetUniquePackageLabelsSample.invokeGetUniquePackageLabels(client, request);
