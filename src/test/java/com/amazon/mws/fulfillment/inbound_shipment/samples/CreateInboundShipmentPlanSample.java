...
/** Sample call for CreateInboundShipmentPlan. */
public class CreateInboundShipmentPlanSample {
     ...
     * @return The response.
     */
    public static CreateInboundShipmentPlanResponse invokeCreateInboundShipmentPlan(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        CreateInboundShipmentPlanSample.invokeCreateInboundShipmentPlan(client, request);
