...
/** Sample call for ConfirmTransportRequest. */
public class ConfirmTransportRequestSample {
     ...
     * @return The response.
     */
    public static ConfirmTransportRequestResponse invokeConfirmTransportRequest(
            FBAInboundServiceMWS client, 
            ConfirmTransportInputRequest request) {
        try {
            // Call the service.
            ConfirmTransportRequestResponse response = client.confirmTransportRequest(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        ConfirmTransportRequestSample.invokeConfirmTransportRequest(client, request);
