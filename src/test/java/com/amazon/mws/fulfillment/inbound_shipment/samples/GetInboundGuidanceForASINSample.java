...
/** Sample call for GetInboundGuidanceForASIN. */
public class GetInboundGuidanceForASINSample {
     ...
     * @return The response.
     */
    public static GetInboundGuidanceForASINResponse invokeGetInboundGuidanceForASIN(
            FBAInboundServiceMWS client, 
            GetInboundGuidanceForASINRequest request) {
        try {
            // Call the service.
            GetInboundGuidanceForASINResponse response = client.getInboundGuidanceForASIN(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        GetInboundGuidanceForASINSample.invokeGetInboundGuidanceForASIN(client, request);
