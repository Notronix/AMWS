...
/** Sample call for GetInboundGuidanceForSKU. */
public class GetInboundGuidanceForSKUSample {
     ...
     * @return The response.
     */
    public static GetInboundGuidanceForSKUResponse invokeGetInboundGuidanceForSKU(
            FBAInboundServiceMWS client, 
            GetInboundGuidanceForSKURequest request) {
        try {
            // Call the service.
            GetInboundGuidanceForSKUResponse response = client.getInboundGuidanceForSKU(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        GetInboundGuidanceForSKUSample.invokeGetInboundGuidanceForSKU(client, request);
