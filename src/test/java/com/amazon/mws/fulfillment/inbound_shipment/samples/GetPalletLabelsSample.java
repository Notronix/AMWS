...
/** Sample call for GetPalletLabels. */
public class GetPalletLabelsSample {
     ...
     * @return The response.
     */
    public static GetPalletLabelsResponse invokeGetPalletLabels(
            FBAInboundServiceMWS client, 
            GetPalletLabelsRequest request) {
        try {
            // Call the service.
            GetPalletLabelsResponse response = client.getPalletLabels(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        GetPalletLabelsSample.invokeGetPalletLabels(client, request);
