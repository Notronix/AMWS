...
/** Sample call for EstimateTransportRequest. */
public class EstimateTransportRequestSample {
     ...
     * @return The response.
     */
    public static EstimateTransportRequestResponse invokeEstimateTransportRequest(
            FBAInboundServiceMWS client, 
            EstimateTransportInputRequest request) {
        try {
            // Call the service.
            EstimateTransportRequestResponse response = client.estimateTransportRequest(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        EstimateTransportRequestSample.invokeEstimateTransportRequest(client, request);
