...
/** Sample async call for PutTransportContent. */
public class PutTransportContentAsyncSample {
     ...
     * @return The response.
     */
    public static List<Object> invokePutTransportContent(
            FBAInboundServiceMWSAsync client, 
            List<PutTransportContentRequest> requestList) {
        // Call the service async.
        List<Future<PutTransportContentResponse>> futureList = 
            new ArrayList<Future<PutTransportContentResponse>>();
        for (PutTransportContentRequest request : requestList) {
            Future<PutTransportContentResponse> future = 
                client.putTransportContentAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<PutTransportContentResponse> future : futureList) {
            Object xresponse;
            try {
                PutTransportContentResponse response = future.get();
    ...
    public static void main(String[] args) {
        ...
        List<PutTransportContentRequest> requestList = new ArrayList<PutTransportContentRequest>();
        ...
        // Make the calls.
        PutTransportContentAsyncSample.invokePutTransportContent(client, requestList);
