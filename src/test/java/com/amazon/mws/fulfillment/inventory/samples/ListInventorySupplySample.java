 ...
 */
package com.amazon.mws.fulfillment.inventory.samples;
...
{
    private static ListInventorySupplyResponse invokeListInventorySupply(FBAInventoryServiceMWS service, ListInventorySupplyRequest request)
    {
        try
        {
            // Call the service.
