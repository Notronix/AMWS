...
/** Sample async call for GetFulfillmentOrder. */
public class GetFulfillmentOrderAsyncSample {
     ...
     * @return The response.
     */
    public static List<Object> invokeGetFulfillmentOrder(
            FBAOutboundServiceMWSAsync client, 
            List<GetFulfillmentOrderRequest> requestList) {
        // Call the service async.
        List<Future<GetFulfillmentOrderResponse>> futureList = 
            new ArrayList<Future<GetFulfillmentOrderResponse>>();
        for (GetFulfillmentOrderRequest request : requestList) {
            Future<GetFulfillmentOrderResponse> future = 
                client.getFulfillmentOrderAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<GetFulfillmentOrderResponse> future : futureList) {
            Object xresponse;
            try {
                GetFulfillmentOrderResponse response = future.get();
    ...
    public static void main(String[] args) {
        ...
        List<GetFulfillmentOrderRequest> requestList = new ArrayList<GetFulfillmentOrderRequest>();
        ...
        // Make the calls.
        GetFulfillmentOrderAsyncSample.invokeGetFulfillmentOrder(client, requestList);
