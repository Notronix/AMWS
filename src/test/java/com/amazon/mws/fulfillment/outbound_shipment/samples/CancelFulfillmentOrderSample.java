...
/** Sample call for CancelFulfillmentOrder. */
public class CancelFulfillmentOrderSample {
     ...
     * @return The response.
     */
    public static CancelFulfillmentOrderResponse invokeCancelFulfillmentOrder(
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        CancelFulfillmentOrderSample.invokeCancelFulfillmentOrder(client, request);
