 ...
 */
package com.amazon.mws.fulfillment.outbound_shipment.mock;
...
public class FBAOutboundServiceMWSMock 
    ...
    */
    ...
    public CreateFulfillmentReturnResponse createFulfillmentReturn(CreateFulfillmentReturnRequest request) 
            throws FBAOutboundServiceMWSException {
        return newResponse(CreateFulfillmentReturnResponse.class);
    }
    ...
    *           CreateFulfillmentReturnRequest request.
    *
    * @return Future<CreateFulfillmentReturnResponse> Future containing completed response
    *
    * @throws FBAOutboundServiceMWSException
    */
    public Future<CreateFulfillmentReturnResponse> createFulfillmentReturnAsync(CreateFulfillmentReturnRequest request) {
        return newFuture(createFulfillmentReturn(request));
    }
    ...
    */
    ...
    public ListReturnReasonCodesResponse listReturnReasonCodes(ListReturnReasonCodesRequest request) 
            throws FBAOutboundServiceMWSException {
        return newResponse(ListReturnReasonCodesResponse.class);
    }
    ...
    *           ListReturnReasonCodesRequest request.
    *
    * @return Future<ListReturnReasonCodesResponse> Future containing completed response
    *
    * @throws FBAOutboundServiceMWSException
    */
    public Future<ListReturnReasonCodesResponse> listReturnReasonCodesAsync(ListReturnReasonCodesRequest request) {
        return newFuture(listReturnReasonCodes(request));
    }
