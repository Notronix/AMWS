...
/** Sample call for ListAllFulfillmentOrdersByNextToken. */
public class ListAllFulfillmentOrdersByNextTokenSample {
     ...
     * @return The response.
     */
    public static ListAllFulfillmentOrdersByNextTokenResponse invokeListAllFulfillmentOrdersByNextToken(
            FBAOutboundServiceMWS client, 
            ListAllFulfillmentOrdersByNextTokenRequest request) {
        try {
            // Call the service.
            ListAllFulfillmentOrdersByNextTokenResponse response = client.listAllFulfillmentOrdersByNextToken(request);
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        ListAllFulfillmentOrdersByNextTokenSample.invokeListAllFulfillmentOrdersByNextToken(client, request);
