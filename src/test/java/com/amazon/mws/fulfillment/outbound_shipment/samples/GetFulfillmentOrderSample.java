...
/** Sample call for GetFulfillmentOrder. */
public class GetFulfillmentOrderSample {
     ...
     * @return The response.
     */
    public static GetFulfillmentOrderResponse invokeGetFulfillmentOrder(
            FBAOutboundServiceMWS service,
    ...
    public static void main(String[] args) {
        ...
        // Make the call.
        GetFulfillmentOrderSample.invokeGetFulfillmentOrder(client, request);
