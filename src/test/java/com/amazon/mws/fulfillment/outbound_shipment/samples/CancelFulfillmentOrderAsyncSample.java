...
/** Sample async call for CancelFulfillmentOrder. */
public class CancelFulfillmentOrderAsyncSample {
     ...
     * @return The response.
     */
    public static List<Object> invokeCancelFulfillmentOrder(
            FBAOutboundServiceMWSAsync client, 
            List<CancelFulfillmentOrderRequest> requestList) {
        // Call the service async.
        List<Future<CancelFulfillmentOrderResponse>> futureList = 
            new ArrayList<Future<CancelFulfillmentOrderResponse>>();
        for (CancelFulfillmentOrderRequest request : requestList) {
            Future<CancelFulfillmentOrderResponse> future = 
                client.cancelFulfillmentOrderAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<CancelFulfillmentOrderResponse> future : futureList) {
            Object xresponse;
            try {
                CancelFulfillmentOrderResponse response = future.get();
    ...
    public static void main(String[] args) {
        ...
        List<CancelFulfillmentOrderRequest> requestList = new ArrayList<CancelFulfillmentOrderRequest>();
        ...
        // Make the calls.
        CancelFulfillmentOrderAsyncSample.invokeCancelFulfillmentOrder(client, requestList);
