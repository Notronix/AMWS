package com.amazon.mws.reports.mock;
...
//    private final Log log = LogFactory.getLog(MarketplaceWebServiceMock.class);
     ...
     * streaming fashion.
     *
     * @param request GetReport Action
     ...
     *
     * @param request GetReportScheduleCount Action
     ...
     *
     * @param request GetReportRequestListByNextToken Action
     ...
     *
     * @param request UpdateReportAcknowledgements Action
     ...
     *
     * @param request SubmitFeed Action
     ...
     *
     * @param request GetReportCount Action
     ...
     * retrieve the next batch of list items and if there are more items to retrieve
     *
     * @param request GetFeedSubmissionListByNextToken Action
     ...
     *
     * @param request CancelFeedSubmissions Action
     ...
     *
     * @param request RequestReport Action
     ...
     *
     * @param request GetFeedSubmissionCount Action
     ...
     *
     * @param request CancelReportRequests Action
     ...
     *
     * @param request GetReportList Action
     ...
     *
     * @param request GetFeedSubmissionResult Action
     ...
     *
     * @param request GetFeedSubmissionList Action
     ...
     *
     * @param request GetReportRequestList Action
     ...
     * retrieve the next batch of list items and if there are more items to retrieve
     *
     * @param request GetReportScheduleListByNextToken Action
     ...
     * retrieve the next batch of list items and if there are more items to retrieve
     *
     * @param request GetReportListByNextToken Action
     ...
     *
     * @param request ManageReportSchedule Action
     ...
     *
     * @param request GetReportRequestCount Action
     ...
     *
     * @param request GetReportScheduleList Action
