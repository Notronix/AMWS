...
{
    private static GetLowestOfferListingsForASINResponse invokeGetLowestOfferListingsForASIN(MarketplaceWebServiceProducts service, GetLowestOfferListingsForASINRequest request)
    {
        try
        {
            // Call the service.
